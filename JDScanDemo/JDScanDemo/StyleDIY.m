...
+ (JDScanViewStyle*)qqStyle
{
    ...
    //扫码框周围4个角的类型,设置为外挂式
    style.photoframeAngleStyle = JDScanViewPhotoframeAngleStyle_Outer;
    ...
    //扫码框内 动画类型 --线条上下移动
    style.anmiationStyle = JDScanViewAnimationStyle_LineMove;
...
+ (JDScanViewStyle*)ZhiFuBaoStyle
{
    ...
    style.photoframeAngleStyle = JDScanViewPhotoframeAngleStyle_Inner;
    style.photoframeLineW = 2.0;
    style.photoframeAngleW = 16;
    style.photoframeAngleH = 16;
    
    style.isNeedShowRetangle = NO;
    style.anmiationStyle = JDScanViewAnimationStyle_NetGrid;
...
+ (JDScanViewStyle*)recoCropRect
{
    ...
    style.centerUpOffset = 44;
    style.photoframeAngleStyle = JDScanViewPhotoframeAngleStyle_On;
    style.photoframeLineW = 6;
    style.photoframeAngleW = 24;
    style.photoframeAngleH = 24;
    style.isNeedShowRetangle = YES;
...
+ (JDScanViewStyle*)notSquare
{
    ...
    style.anmiationStyle = JDScanViewAnimationStyle_LineStill;
