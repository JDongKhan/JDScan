...
#import "UIActionSheet+JDAlertAction.h"

@implementation JDAlertAction
...
+ (void)showAlertWithTitle:(NSString*)title msg:(NSString*)message buttonsStatement:(NSArray<NSString*>*)arrayItems chooseBlock:(void (^)(NSInteger buttonIdx))block {
    ...
    if ( [JDAlertAction isIosVersion8AndAfter]) {
        ...
        [[JDAlertAction getTopViewController] presentViewController:alertController animated:YES completion:nil];
